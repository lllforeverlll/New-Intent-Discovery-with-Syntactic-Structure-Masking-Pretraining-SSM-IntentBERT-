...
def parseArgument():
    ...
    parser.add_argument('--mlm', default="True",
...
def main():
    ...
    if args.saveModel:
        ...
        if args.saveName == 'none':
            ...
            if args.mlm:
                if args.mlm_data == 'target':
                    ...
                    prefix += "_source"
            save_path = os.path.join("IntentBert-main/saved_models", f'{prefix}_{args.mode}_{args.sourceDomain}')
            if args.shuffle:
                save_path += "_shuffle"
            if args.shuffle_mlm:
        ...
        if not os.path.exists(save_path):
            os.mkdir(save_path)
        model.save("IntentBert-main/finalmodel/best")
    lastModelStateDict = trainer.getLastModelStateDict()
    
    model.load_state_dict(lastModelStateDict)
    model.save("IntentBert-main/finalmodel/final")
    
    
    ModelStateDict = trainer.getModelStateDict10()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/10")
    ModelStateDict = trainer.getModelStateDict11()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/11")
    ModelStateDict = trainer.getModelStateDict12()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/12")
    ModelStateDict = trainer.getModelStateDict13()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/13")
    ModelStateDict = trainer.getModelStateDict14()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/14")
    ModelStateDict = trainer.getModelStateDict15()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/15")
    ModelStateDict = trainer.getModelStateDict16()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/16")
    ModelStateDict = trainer.getModelStateDict17()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/17")
    ModelStateDict = trainer.getModelStateDict18()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/18")
    ModelStateDict = trainer.getModelStateDict19()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/19")
    ModelStateDict = trainer.getModelStateDict9()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/9")
    ModelStateDict = trainer.getModelStateDict8()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/8")
    ModelStateDict = trainer.getModelStateDict7()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/7")
    ModelStateDict = trainer.getModelStateDict6()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/6")
    ModelStateDict = trainer.getModelStateDict5()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/5")
    ModelStateDict = trainer.getModelStateDict4()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/4")
    ModelStateDict = trainer.getModelStateDict3()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/3")
    ModelStateDict = trainer.getModelStateDict2()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/2")
    ModelStateDict = trainer.getModelStateDict1()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/1")
    ModelStateDict = trainer.getModelStateDict20()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/20")
    ModelStateDict = trainer.getModelStateDict21()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/21")
    ModelStateDict = trainer.getModelStateDict22()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/22")
    ModelStateDict = trainer.getModelStateDict23()
    model.load_state_dict(ModelStateDict)
    model.save("IntentBert-main/finalmodel/23")
    # ModelStateDict = trainer.getModelStateDict24()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/24")
    # ModelStateDict = trainer.getModelStateDict25()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/25")
    # ModelStateDict = trainer.getModelStateDict26()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/26")
    # ModelStateDict = trainer.getModelStateDict27()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/27")
    # ModelStateDict = trainer.getModelStateDict28()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/28")
    # ModelStateDict = trainer.getModelStateDict29()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/29")
    # ModelStateDict = trainer.getModelStateDict30()
    # model.load_state_dict(ModelStateDict)
    # model.save("IntentBert-main/finalmodel/30")
