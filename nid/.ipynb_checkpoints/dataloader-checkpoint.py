...
class Data:
    ...
    def __init__(self, args):
        ...
        self.semi_input_ids, self.semi_input_mask, self.semi_segment_ids, self.semi_label_ids, self.semi_pos_ids = self.get_semi(self.train_labeled_examples, self.train_unlabeled_examples, args)
        self.train_semi_dataset, self.train_semi_dataloader = self.get_semi_loader(self.semi_input_ids, self.semi_input_mask, self.semi_segment_ids, self.semi_label_ids,self.semi_pos_ids, args)
    ...
    def get_semi(self, labeled_examples, unlabeled_examples, args):
        ...
        unlabeled_pos_ids=torch.tensor([f.pos_ids for f in unlabeled_features], dtype=torch.long)
        ...
        if self.n_known_cls > 0:
            ...
            semi_pos_ids = unlabeled_pos_ids
        else:
            ...
            semi_pos_ids = unlabeled_pos_ids
        return semi_input_ids, semi_input_mask, semi_segment_ids, semi_label_ids, semi_pos_ids

    def get_semi_loader(self, semi_input_ids, semi_input_mask, semi_segment_ids, semi_label_ids,semi_pos_ids, args):
        semi_data = TensorDataset(semi_input_ids, semi_input_mask, semi_segment_ids, semi_label_ids,semi_pos_ids)
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, segment_ids, label_id,pos_ids):
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        pos_ids=dataList[ex_index][0:21]
        features.append(
