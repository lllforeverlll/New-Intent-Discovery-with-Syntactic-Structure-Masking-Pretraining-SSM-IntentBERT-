    ...
    def train(self, args, data):
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for batch in tqdm(self.train_dataloader, desc="Iteration"):
                ...
                anchor_pos_ids=batch["anchor_pos_ids"]
                neighbor_pos_ids=batch["neighbor_pos_ids"]
                ...
                if args.view_strategy == "rtr":
                    X_an = {"input_ids":self.generator.random_token_replace(anchor[0].cpu(),anchor_pos_ids).to(self.device), "attention_mask":anchor[1], "token_type_ids":anchor[2]}
                    X_ng = {"input_ids":self.generator.random_token_replace(neighbor[0].cpu(),neighbor_pos_ids).to(self.device), "attention_mask":neighbor[1], "token_type_ids":neighbor[2]}
